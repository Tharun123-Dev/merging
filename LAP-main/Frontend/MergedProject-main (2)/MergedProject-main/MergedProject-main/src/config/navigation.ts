...
export const navigationConfig: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: 'hrms', label: 'HRMS', path: '/attendance', icon: Clock, module: 'hrms', permissions: ['ATTENDANCE_VIEW', 'LEAVE_VIEW', 'PAYROLL_VIEW', 'SALARY_VIEW'] },
      { id: 'crm', label: 'CRM', path: '/leads', icon: Users, module: 'crm', permissions: ['LEAD_VIEW', 'CRM_VIEW'] },
      { id: 'tasks', label: 'Tasks', path: '/tasks', icon: CheckSquare, badge: 8, permissions: ['TASK_VIEW'] },
      { id: 'tickets', label: 'Support Tickets', path: '/tickets', icon: Headphones, badge: 4, permissions: ['SUPPORT_TICKET_VIEW', 'SUPPORT_TICKET_CREATE', 'SUPPORT_VIEW'] },
      { id: 'affiliate', label: 'Affiliate', path: '/affiliate', icon: Share2, module: 'crm', permissions: ['AFFILIATE_VIEW', 'AFFILIATE_MANAGE'] },
      ...
      { id: 'reports', label: 'Reports', path: '/reports', icon: BarChart3, permissions: ['REPORT_VIEW', 'REPORTS_VIEW'] },
      { id: 'self-reports', label: 'Self Reports', path: '/self-reports', icon: BarChart3, permissions: ['REPORT_SELF', 'SELF_REPORTS_VIEW'] },
      { id: 'revenue', label: 'Revenue', path: '/revenue', icon: IndianRupee, permissions: ['REVENUE_VIEW'] },
    ],
  }
]
