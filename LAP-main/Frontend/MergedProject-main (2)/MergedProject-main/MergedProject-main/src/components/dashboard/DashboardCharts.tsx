...
export function DashboardCharts() {
  ...
  const canViewRevenue = hasAnyPermission(['REVENUE_VIEW', 'REVENUE_MANAGE', 'REPORT_VIEW'])
  const canViewPipeline = hasAnyPermission(['LEAD_VIEW', 'CRM_VIEW', 'REPORT_VIEW'])
  const canViewReports = hasAnyPermission(['REPORT_VIEW', 'REPORT_CREATE'])
