                  ...
                  <tr key={inv.id} className="hover:bg-muted/30 transition-colors group">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <button onClick={() => window.open(`/vendor-dashboard/invoices/${inv.id}/receipt`, '_blank')} className="btn-icon text-indigo-400 hover:text-indigo-300 hover:bg-indigo-400/10 cursor-pointer" title="Generate Payment Receipt">
                          <FileText size={16} />
                        </button>
