            ...
            <div className="flex border-b border-border">
              {['ACTIVE', 'INACTIVE', 'EXPIRED', 'DELETED', 'ALL'].map(tab => (
                <button 
                  ...
                  className={`px-4 py-3 text-xs font-bold transition-all border-b-2 hover:text-cyan-400 cursor-pointer ${
                    viewTab === tab ? 'border-cyan-500 text-cyan-400' : 'border-transparent text-muted-foreground'
                  }`}
                >
                  {tab}
                </button>
